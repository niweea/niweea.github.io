...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},Bp=(e,t)=>new Wo(e,t)}),Vo,ji,Go,Ho,Fo,jo,Ue,Dp,Np,bt=q(()=>{"use strict";re(),ie(),Te(),ae(),Vo=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},ji=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),Go=(e,t)=>R.sortBasedOnPerm(e,ji(e.length,t)),Ho=(e,t,r,i)=>{let a=`fn perm(i: ${i.type.indices}) -> ${r.type.indices} {
  ...
  }`},{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let y=R.size(n);return{outputs:[{dims:n,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(y/64/4)},programUniforms:[{type:12,data:Math.ceil(y/4)}]}},getShaderSource:p};let{newShape:h,newPerm:c}=Fo(e.dims,a),g=R.areEqual(c,[2,3,1]),_=R.areEqual(c,[3,1,2]);if(h.length===2||g||_){s=g?[h[0],h[1]*h[2]]:_?[h[0]*h[1],h[2]]:h,u=[s[1],s[0]];let y=16;return p=w=>{let S=M("a",r,s.length),x=Z("output",r,u.length);return`
    ...
    ${S.setByOffset("global_idx",w.getByIndices("aIndices"))}
       ...
       `,y=w=>`
        ...
        fn DIV_CEIL(a : u32, b : u32) -> u32 {
         ...
         if (local_idx == 0u) {
          ${c.setByOffset("outputIndex",`${i==="mean"?`${c.type.storage}(bestValue / f32(uniforms.reduceSize))`:`${c.type.storage}(${Qo[i]})`}`)};
         }
        }`;return{name:e,shaderCache:{hint:`${t};${g}`,inputDependencies:["type"]},getShaderSource:y,getRunData:()=>({outputs:[{dims:n,dataType:a}],dispatchGroup:{x:l},programUniforms:[{type:12,data:p}]})}},Ve=(e,t,r,i)=>{let a=e.inputs.length===1?r:Ra(e.inputs,r),n=a.axes;n.length===0&&!a.noopWithEmptyAxes&&(n=e.inputs[0].dims.map((_,y)=>y));let s=R.normalizeAxes(n,e.inputs[0].dims.length),u=s,l=e.inputs[0],p=ru(u,e.inputs[0].dims.length);p.length>0&&(l=e.compute(Ue(e.inputs[0],p),{inputs:[0],outputs:[-1]})[0],u=Yo(u.length,l.dims.length));let[h,c]=Jo(l.dims,u),g=h;a.keepDims&&(g=eu(h,s)),e.compute(iu(t,a.cacheKey,[l],i,e.inputs[0].dataType,g,c),{inputs:[l]})},Up=(e,t)=>{Ve(e,"ReduceMeanShared",t,"mean")},Pp=(e,t)=>{Ve(e,"ReduceL1Shared",t,"l1")},qp=(e,t)=>{Ve(e,"ReduceL2Shared",t,"l2")},Lp=(e,t)=>{Ve(e,"ReduceLogSumExpShared",t,"logSumExp")},Wp=(e,t)=>{Ve(e,"ReduceMaxShared",t,"max")},Vp=(e,t)=>{Ve(e,"ReduceMinShared",t,"min")},Gp=(e,t)=>{Ve(e,"ReduceProdShared",t,"prod")},Hp=(e,t)=>{Ve(e,"ReduceSumShared",t,"sum")},Fp=(e,t)=>{Ve(e,"ReduceSumSquareShared",t,"sumSquare")},jp=(e,t)=>{Ve(e,"ReduceLogSumShared",t,"logSum")}}),Ge,au,Qr,Ra,He,nu,su,ou,uu,lu,du,pu,cu,hu,fu,Fe,Kp,Zp,Xp,Qp,Yp,Jp,ec,tc,rc,ic,an=q(()=>{"use strict";re(),ie(),Te(),ae(),E0(),Ge=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},au=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Qr=(e,t,r,i,a,n,s=!1,u=!1)=>{let l=[],p=r[0].dims,h=p.length,c=R.normalizeAxes(a,h),g=!u&&c.length===0;p.forEach((w,S)=>{g||c.indexOf(S)>=0?s&&l.push(1):l.push(w)});let _=l.length,y=R.size(l);return{name:e,shaderCache:t,getShaderSource:w=>{let S=[],x=M("_A",r[0].dataType,h),b=Z("output",n,_),k=i(x,b,c),T=k[2];for(let E=0,z=0;E<h;E++)g||c.indexOf(E)>=0?(s&&z++,T=`for(var j${E}: u32 = 0; j${E} < ${p[E]}; j${E}++) {
...
var best_index : i32 = 0;`,`if (${i.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`};return{name:"AttentionProbsSoftmax",shaderCache:{hint:`${p};${_};${l}`,inputDependencies:w},getShaderSource:S,getRunData:()=>({outputs:[],dispatchGroup:{x:1,y:a,z:t*r},programUniforms:g})}},yu=(e,t,r,i,a,n,s,u,l)=>{let p=s+n.kvSequenceLength,h=[n.batchSize,n.numHeads,n.sequenceLength,p],c=e>1&&i,g=n.kvNumHeads?n.kvNumHeads:n.numHeads,_=c?[n.batchSize,g,p,n.headSize]:void 0,y=n.nReps?n.nReps:1,w=n.scale===0?1/Math.sqrt(n.headSize):n.scale,S=Se(n.headSize),x=n.headSize/S,b=12,k={x:Math.ceil(p/b),y:Math.ceil(n.sequenceLength/b),z:n.batchSize*n.numHeads},T=[{type:12,data:n.sequenceLength},{type:12,data:x},{type:12,data:p},{type:12,data:n.numHeads},{type:12,data:n.headSize},{type:1,data:w},{type:12,data:s},{type:12,data:n.kvSequenceLength},{type:12,data:y}],E=c&&i&&R.size(i.dims)>0,z=["type","type"];E&&z.push("type"),a&&z.push("type"),u&&z.push("type"),l&&z.push("type");let A=[{dims:h,dataType:t.dataType,gpuDataType:0}];c&&A.push({dims:_,dataType:t.dataType,gpuDataType:0});let v=N=>{let L=M("q",t.dataType,t.dims,S),H=M("key",r.dataType,r.dims,S),P=[L,H];if(E){let j=M("past_key",i.dataType,i.dims,S);P.push(j)}a&&P.push(M("attention_bias",a.dataType,a.dims));let V=u?M("seq_lens",u.dataType,u.dims):void 0;V&&P.push(V);let Y=l?M("total_sequence_length_input",l.dataType,l.dims):void 0;Y&&P.push(Y);let C=Z("output",t.dataType,h),U=[C];c&&U.push(Z("present_key",t.dataType,_,S));let J=Ie(1,S),te=[{name:"M",type:"u32"},{name:"K",type:"u32"},{name:"N",type:"u32"},{name:"num_heads",type:"u32"},{name:"head_size",type:"u32"},{name:"alpha",type:"f32"},{name:"past_sequence_length",type:"u32"},{name:"kv_sequence_length",type:"u32"},{name:"n_reps",type:"u32"}];return`
  const TILE_SIZE = ${b}u;
  ...
  }`};return{name:"AttentionProbs",shaderCache:{hint:`${S};${a!==void 0};${i!==void 0};${e}`,inputDependencies:z},getRunData:()=>({outputs:A,dispatchGroup:k,programUniforms:T}),getShaderSource:v}},_u=(e,t,r,i,a,n,s=void 0,u=void 0)=>{let l=n+a.kvSequenceLength,p=a.nReps?a.nReps:1,h=a.vHiddenSize*p,c=e>1&&i,g=a.kvNumHeads?a.kvNumHeads:a.numHeads,_=c?[a.batchSize,g,l,a.headSize]:void 0,y=[a.batchSize,a.sequenceLength,h],w=12,S={x:Math.ceil(a.vHeadSize/w),y:Math.ceil(a.sequenceLength/w),z:a.batchSize*a.numHeads},x=[{type:12,data:a.sequenceLength},{type:12,data:l},{type:12,data:a.vHeadSize},{type:12,data:a.numHeads},{type:12,data:a.headSize},{type:12,data:h},{type:12,data:n},{type:12,data:a.kvSequenceLength},{type:12,data:p}],b=c&&i&&R.size(i.dims)>0,k=["type","type"];b&&k.push("type"),s&&k.push("type"),u&&k.push("type");let T=[{dims:y,dataType:t.dataType,gpuDataType:0}];c&&T.push({dims:_,dataType:t.dataType,gpuDataType:0});let E=z=>{let A=M("probs",t.dataType,t.dims),v=M("v",r.dataType,r.dims),N=[A,v];b&&N.push(M("past_value",i.dataType,i.dims));let L=s?M("seq_lens",s.dataType,s.dims):void 0;s&&N.push(L);let H=u?M("total_sequence_length_input",u.dataType,u.dims):void 0;u&&N.push(H);let P=[Z("output",t.dataType,y)];c&&P.push(Z("present_value",t.dataType,_));let V=[{name:"M",type:"u32"},{name:"K",type:"u32"},{name:"N",type:"u32"},{name:"num_heads",type:"u32"},{name:"head_size",type:"u32"},{name:"v_hidden_size",type:"u32"},{name:"past_sequence_length",type:"u32"},{name:"kv_sequence_length",type:"u32"},{name:"n_reps",type:"u32"}];return`
  const TILE_SIZE = ${w}u;
  ...
  }`};return{name:"AttentionScore",shaderCache:{hint:`${i!==void 0};${e}`,inputDependencies:k},getRunData:()=>({outputs:T,dispatchGroup:S,programUniforms:x}),getShaderSource:E}},gr=(e,t,r,i,a,n,s,u,l,p,h=void 0,c=void 0)=>{let g=Math.min(e.outputCount,1+(s?1:0)+(u?1:0)),_=g>1?s:void 0,y=g>1?u:void 0,w=g>1?p.pastSequenceLength:0,S=w+p.kvSequenceLength,x=l&&R.size(l.dims)>0?l:void 0,b=[t,r];_&&R.size(_.dims)>0&&b.push(_),x&&b.push(x),h&&b.push(h),c&&b.push(c);let k=e.compute(yu(g,t,r,_,x,p,w,h,c),{inputs:b,outputs:g>1?[-1,1]:[-1]})[0];e.compute(gu(k,p.batchSize,p.numHeads,w,p.sequenceLength,S,h,c),{inputs:h&&c?[k,h,c]:[k],outputs:[]});let T=[k,i];y&&R.size(y.dims)>0&&T.push(y),h&&T.push(h),c&&T.push(c),e.compute(_u(g,k,i,y,p,w,h,c),{inputs:T,outputs:g>1?[0,2]:[0]})},bu=(e,t)=>{let r=[t.batchSize,t.numHeads,t.sequenceLength,t.headSize],i=t.sequenceLength,a=t.inputHiddenSize,n=t.headSize,s=12,u={x:Math.ceil(t.headSize/s),y:Math.ceil(t.sequenceLength/s),z:t.batchSize*t.numHeads},l=[e.inputs[0],e.inputs[1],e.inputs[2]],p=[{type:12,data:i},{type:12,data:a},{type:12,data:n},{type:12,data:t.numHeads},{type:12,data:t.headSize},{type:12,data:t.hiddenSize},{type:12,data:t.hiddenSize+t.hiddenSize+t.vHiddenSize}],h=c=>{let g=Z("output_q",l[0].dataType,r),_=Z("output_k",l[0].dataType,r),y=Z("output_v",l[0].dataType,r),w=M("input",l[0].dataType,l[0].dims),S=M("weight",l[1].dataType,l[1].dims),x=M("bias",l[2].dataType,l[2].dims),b=w.type.storage,k=[{name:"M",type:"u32"},{name:"K",type:"u32"},{name:"N",type:"u32"},{name:"num_heads",type:"u32"},{name:"head_size",type:"u32"},{name:"hidden_size",type:"u32"},{name:"ldb",type:"u32"}];return`
  const TILE_SIZE = ${s}u;
  ...
  ${c.registerUniforms(k).declareVariables(w,S,x,g,_,y)}
  ${c.mainStart([s,s,1])}
  ...
  const epsilon = ${r};
  ${k.registerUniform("outputSize","u32").declareVariables(c,g,_,y,w,S)}
  ${k.mainStart()}
  ...
  }`}},uc=e=>{xu(e.inputs),e.compute(Su(e.inputs))}}),Tu,ce,lc,dc,pc,cc,hc,fc,mc,gc,yc,ku,_c,bc,wc,$c,cr,vc,Fr,xc,Sc,Tc,kc,Ic,Ec,zc,Cc,Ac,Oc,Rc,Mc,Bc,Dc,Nc,Uc,Pc,Zi,qc,Ba,Da,Lc,Wc,Vc,Iu,Eu,Gc,sn=q(()=>{"use strict";re(),ie(),Te(),ae(),Tu=(e,t,r,i,a,n,s)=>{let u=Math.ceil(t/4),l="";typeof a=="string"?l=`${a}(a)`:l=a("a");let p=M("inputData",r,[u],4),h=Z("outputData",i,[u],4),c=[{name:"vec_size",type:"u32"}];return s&&c.push(...s),`
...
`,Eu=e=>`quick_gelu_impl(${e})`,Gc=(e,t)=>{let r=Ie(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"QuickGelu",Eu,Iu(r,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),zu,Cu,Hc,O0=q(()=>{"use strict";ie(),ae(),sn(),zu=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Cu=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=M("input",e[0].dataType,e[0].dims,4),i=M("bias",e[0].dataType,[e[0].dims[2]],4),a=Z("output",e[0].dataType,t,4),n=R.size(t)/4,s=Ee(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    ${a.setByOffset("global_idx","valueLeft * geluRight")}
  }`}},Hc=e=>{zu(e.inputs),e.compute(Cu(e.inputs))}}),Au,Ou,je,Fc,jc,Kc,Zc,Xc,Qc,Yc,Jc,eh,th,R0=q(()=>{"use strict";re(),ie(),ae(),Au=(e,t,r,i,a,n,s,u,l,p,h,c)=>{let g,_;typeof u=="string"?g=_=(b,k)=>`${u}((${b}),(${k}))`:typeof u=="function"?g=_=u:(g=u.scalar,_=u.vector);let y=Z("outputData",h,i.length,4),w=M("aData",l,t.length,4),S=M("bData",p,r.length,4),x;if(a)if(n){let b=R.size(t)===1,k=R.size(r)===1,T=t.length>0&&t[t.length-1]%4===0,E=r.length>0&&r[r.length-1]%4===0;b||k?x=y.setByOffset("global_idx",_(b?`${w.type.value}(${w.getByOffset("0")}.x)`:w.getByOffset("global_idx"),k?`${S.type.value}(${S.getByOffset("0")}.x)`:S.getByOffset("global_idx"))):x=`
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${x}
      }`},Ou=(e,t,r,i,a,n,s=r.dataType)=>{let u=r.dims.map(Number),l=i.dims.map(Number),p=!R.areEqual(u,l),h=u,c=R.size(u),g=!1,_=!1,y=[p];if(p){let w=Ht.calcShape(u,l,!1);if(!w)throw new Error("Can't perform binary op on the given tensors");h=w.slice(),c=R.size(h);let S=R.size(u)===1,x=R.size(l)===1,b=u.length>0&&u[u.length-1]%4===0,k=l.length>0&&l[l.length-1]%4===0;y.push(S),y.push(x),y.push(b),y.push(k);let T=1;for(let E=1;E<h.length;E++){let z=u[u.length-E],A=l[l.length-E];if(z===A)T*=z;else break}T%4===0?(_=!0,g=!0):(S||x||b||k)&&(g=!0)}else g=!0;return y.push(g),{name:e,shaderCache:{hint:t+y.map(w=>w.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:w=>Au(w,u,l,h,g,p,_,a,r.dataType,i.dataType,s,n),getRunData:()=>({outputs:[{dims:h,dataType:s}],dispatchGroup:{x:Math.ceil(c/64/4)},programUniforms:[{type:12,data:Math.ceil(R.size(h)/4)},...Q(u,l,h)]})}},je=(e,t,r,i,a,n)=>{e.compute(Ou(t,a??"",e.inputs[0],e.inputs[1],r,i,n))},Fc=e=>{je(e,"Add",(t,r)=>`${t}+${r}`)},jc=e=>{je(e,"Div",(t,r)=>`${t}/${r}`)},Kc=e=>{je(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},Zc=e=>{je(e,"Mul",(t,r)=>`${t}*${r}`)},Xc=e=>{let t=M("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;je(e,"Pow",{scalar:(r,i)=>`pow_custom(${r},${i})`,vector:(r,i)=>`pow_vector_custom(${r},${i})`},`
...
`)},Du=(e,t,r,i)=>{let a=R.size(r),n=new Array(e.length),s=new Array(e.length),u=0,l=[],p=[],h=[{type:12,data:a}];for(let w=0;w<e.length;++w)u+=e[w].dims[t],n[w]=u,p.push(e[w].dims.length),s[w]=M(`input${w}`,i,p[w]),l.push("rank"),h.push({type:12,data:n[w]});for(let w=0;w<e.length;++w)h.push(...Q(e[w].dims));h.push(...Q(r));let c=Z("output",i,r.length),g=c.indicesGet("indices",t),_=Array.from(Array(n.length).keys()).map(w=>`uniforms.sizeInConcatAxis${w}`).join(","),y=w=>`
...
`},ln=(e,t,r,i,a=!1,n)=>{let s=e[0].dims,u=e[1].dims,l=s[s.length-2],p=u[u.length-1],h=s[s.length-1],c=Se(p),g=Se(h),_=Se(l),y=R.size(r)/c/_,w=e.length>2,S=i?i.slice(0,-2):r.slice(0,-2),x=[R.size(S),l,p],b=[{type:12,data:y},{type:12,data:l},{type:12,data:p},{type:12,data:h}];Dt(t,b),b.push(...Q(S,s,u)),w&&b.push(...Q(e[2].dims)),b.push(...Q(x));let k=T=>{let E=rn("batch_dims",e[0].dataType,S.length),z=M("a",e[0].dataType,s.length,g),A=M("b",e[1].dataType,u.length,c),v=Z("output",e[0].dataType,x.length,c),N=Ee(v.type.tensor),L=Bt(t,v.type.value,N),H=[z,A],P="";if(w){let C=a?c:1;H.push(M("bias",e[2].dataType,e[2].dims.length,C)),P=`${a?`value += bias[col / ${C}];`:`value += ${v.type.value}(bias[row + i]);`}`}let V=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];Nt(t,V);let Y=()=>{let C=`var a_data: ${z.type.value};`;for(let U=0;U<g;U++)C+=`
              let b_data${U} = b[(b_offset + (k + ${U}) * uniforms.N + col) / ${c}];`;for(let U=0;U<_;U++){C+=`a_data = a[(a_offset + (row + ${U}) * uniforms.K + k) / ${g}];`;for(let J=0;J<g;J++)C+=`
...
`}return C};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${c};${g};${_};${a}`,inputDependencies:w?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:n?n(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(y/64)},programUniforms:b}),getShaderSource:k}}}),Nu,Uu,Na,Xi,Pu,Ua,qu,Yr,pn=q(()=>{"use strict";re(),ie(),ae(),Pt(),dn(),un(),Nu=(e,t)=>e?`
        ...
        }`,Na=(e,t,r="f32",i,a=!1,n=32,s=!1,u=32)=>{let l=t[1]*e[1],p=t[0]*e[0],h=a?l:n,c=a?n:l,g=h/t[0],_=n/t[1];if(!((a&&g===4&&e[1]===4||!a&&(g===3||g===4))&&h%t[0]===0&&n%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${a} is true, innerElementSize ${g} and workPerThread[1] ${e[1]} must be 4.
...
`},qu=(e,t,r,i,a=!1)=>{let[n,s,u,l]=i,p=Ee(i[0].type.tensor);return`
  ...
  ${w?Na(S,x,U,C):Ua(S,x,U,C)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${E}) {
    ...
    }`},sh=(e,t,r,i,a,n,s,u,l)=>{let p=t.format==="NHWC",h=p?e[0].dims[3]:e[0].dims[1],c=r[0],g=p?r[2]:r[3],_=p?r[1]:r[2],y=p?r[3]:r[1],w=p&&(h%4===0||h%3===0)&&y%4===0,S=p?y:g*_,x=p?g*_:y,b=[8,8,1],k=i<=8?[4,1,1]:[4,4,1],T=[Math.ceil(S/b[0]/k[0]),Math.ceil(x/b[1]/k[1]),Math.ceil(c/b[2]/k[2])];de("verbose",()=>`[conv2d_mm_webgpu] dispatch = ${T}`);let E=w?p&&h%4!==0?3:4:1,z=b[1]*k[1],A=b[0]*k[0],v=Math.max(b[0]*E,b[1]),N=i%z===0,L=a%A===0,H=n%v===0,P=w?[E,4,4]:[1,1,1],V=[{type:6,data:i},{type:6,data:a},{type:6,data:n},{type:6,data:[t.pads[0],t.pads[1]]},{type:6,data:t.strides},{type:6,data:t.dilations}];Dt(t,V),V.push(...Q(e[0].dims,e[1].dims));let Y=["rank","rank"];s&&(V.push(...Q(e[2].dims)),Y.push("rank")),V.push(...Q(r));let C=U=>{let J=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"},{name:"pad",type:"i32",length:2},{name:"stride",type:"i32",length:2},{name:"dilation",type:"i32",length:2}];Nt(t,J);let te=w?4:1,j=Ee(e[0].dataType),ne=`
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${w?`vec4<${j}>`:j}) {
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${l?`vec4<${E}>`:E} {
          ...
          }`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${s};${g};${S}`,inputDependencies:w},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:c[0],y:c[1],z:c[2]},programUniforms:y}),getShaderSource:x}}}),lh,dh,U0=q(()=>{"use strict";re(),ie(),ae(),Pt(),lh=(e,t,r,i)=>{let a=e.length>2,n=a?"value += b[output_channel];":"",s=e[0].dims,u=e[1].dims,l=t.format==="NHWC",p=l?r[3]:r[1],h=p/t.group,c=l&&h>=4?Se(p):1,g=R.size(r)/c,_=[{type:12,data:g},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:h}];Dt(t,_),_.push(...Q(s,[u[0],u[1],u[2],u[3]/c]));let y=a?["rank","rank","rank"]:["rank","rank"];_.push(...Q([r[0],r[1],r[2],r[3]/c]));let w=S=>{let x=Z("output",e[0].dataType,r.length,c),b=Ee(x.type.tensor),k=Bt(t,x.type.value,b),T=M("x",e[0].dataType,s.length),E=M("w",e[1].dataType,u.length,c),z=[T,E];a&&z.push(M("b",e[2].dataType,e[2].dims,c));let A=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];Nt(t,A);let v=l?`
    ...
    for (var i = 0u; i < ${s}u; i++) {
      ...
      ${w.set("batch","row","col + i","output_channel","value")};
        ...
        `,h===1)K+=`
          ...
          dotProd = dotProd + xValue * wValue;`;else for(let F=0;F<h;F++)K+=`
            let wValue${F} = ${U.getByOffset(`${U.indicesToOffset(`${U.type.indices}(u32(wRPerm), u32(wCPerm), inputChannel + ${F}, wOutChannel)`)} / ${w}`)};
            dotProd = dotProd + xValue[${F}] * wValue${F};`;return K},D=()=>{if(_===0)return"";if(!c)throw new Error(`packInputAs4 ${c} is not true.`);let K="";if(h===1){K+="dotProd = dotProd";for(let F=0;F<_;F++)K+=`
            + ${J.getByOffset(`x_offset + ${F}`)} * ${U.getByOffset(`w_offset + ${F}`)}`;K+=";"}else if(h===2){if(_!==2)throw new Error(`Invalid inputChannelsRemainder ${_}.`);K+=`
          let xValue = ${J.getByOffset("x_offset")};
          let wValue = ${U.getByOffset("w_offset")};
...
`)},il=(e,t)=>{let r,i,a,n,s,u,l=t.format==="NHWC",p=t.blocksize,h=t.mode==="DCR";l?([r,i,a,n]=e.dims,s=h?[r,i,a,p,p,n/p**2]:[r,i,a,n/p**2,p,p],u=h?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([r,i,a,n]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],s=h?[r,p,p,n/p**2,i,a]:[r,n/p**2,p,p,i,a],u=h?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let c=e.reshape(s),g=c.dims.length,_=e.dataType,y=M("a",_,g),w=Z("output",_,g),S=x=>`
  ...
  }`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:x=>{let b=l?[r,i*p,a*p,n/p**2]:[r,n/p**2,i*p,a*p],k=R.size(b),T=c.dims,E=R.sortBasedOnPerm(T,u);return{outputs:[{dims:b,dataType:x[0].dataType}],dispatchGroup:{x:Math.ceil(k/64)},programUniforms:[{type:12,data:k},...Q(T,E)]}},getShaderSource:S}},gh=(e,t)=>{tl(e.inputs),e.compute(il(e.inputs[0],t))},yh=e=>he({blocksize:e.blocksize,mode:e.mode,format:e.format})}),it,nr,qr,ra,ft,al,nl,sl,ia,aa,na,ol,ul,sa,ll,_h,bh,G0=q(()=>{"use strict";re(),ie(),Te(),ae(),it=256,nr=512,qr=2*Math.PI,ra=e=>{let t=[],r=e;for(let i of[4,2,3,5])for(;r%i===0;)t.push(i),r/=i;return r===1?t:void 0},ft=e=>{let t=e.toPrecision(9);return/[.eE]/.test(t)?t:`${t}.0`},al=(e,t,r,i,a)=>{let n=r/e,s=nr-i,u=p=>`smem[${s}u + base + ${p*t}u]`,l=`  for (var t = local_idx; t < ${n}u; t += ${it}u) {
`;l+=`    let twiddleIndex = t % ${t}u;
    let angleUnit = f32(twiddleIndex);
`,l+=`    var leg: array<vec2<f32>, 5>;
`;for(let p=0;p<e;p++){let h=`${i}u + t + ${p*n}u`;if(p===0)l+=`    leg[0] = smem[${h}];
`;else{let c=a*qr*p/(e*t);l+=`    { let a = ${ft(c)} * angleUnit; leg[${p}] = cmul(smem[${h}], vec2<f32>(cos(a), sin(a))); }
...
`,l+=`    ${u(2)} = evenSum - oddSum;
    ${u(3)} = evenDiff - oddRot;
`}else for(let p=0;p<e;p++){let h=["leg[0]"];for(let c=1;c<e;c++){let g=a*qr*(c*p)/e,_=ft(Math.cos(g)),y=ft(Math.sin(g));h.push(`vec2<f32>(leg[${c}].x*${_} - leg[${c}].y*${y}, leg[${c}].x*${y} + leg[${c}].y*${_})`)}l+=`    ${u(p)} = ${h.join(" + ")};
`}return`${l}  }
  workgroupBarrier();
`},nl=(e,t,r)=>{let i="",a=1,n=0;for(let s of e)i+=al(s,a,t,n,r),a*=s,n=nr-n;return{code:i,resultOffset:n}},sl=(e,t,r,i,a)=>{let n=e.dims,s=n.length,u=n[s-1],l=n[t],p=r&&i?(l-1)*2:l;a!==void 0&&(p=a);let h=r&&i?1:2,c=i&&!r?Math.floor(p/2)+1:p,g=n.slice();g[t]=c,g[s-1]=h;let _=1;for(let w=t+1;w<s-1;w++)_*=n[w];let y=R.size(n)/u/l;return{dataType:e.dataType,outputDims:g,length:p,signalLength:l,inner:_,batch:y,inputComponents:u,outputComponents:h,outputLength:c,inverse:r,onesided:i}},ia=(e,t)=>[t,e.length,e.inputComponents,e.outputComponents,e.inverse,e.onesided].join(";"),aa=e=>[{type:12,data:e.batch},{type:12,data:e.signalLength},{type:12,data:e.inner},{type:12,data:e.outputLength}],na=(e,t,r)=>e.registerUniform("batch","u32").registerUniform("signalLength","u32").registerUniform("inner","u32").registerUniform("outputLength","u32").declareVariables(t,r),ol=e=>{let{dataType:t,length:r,inputComponents:i,outputComponents:a,inverse:n,onesided:s}=e,u=Ie(t),l=n?1:-1,p=n?1/r:1,h=ra(r),c=g=>{let _=M("x",t,[1]),y=Z("y",t,[1]),w=E=>{let z=`inBase + (${E}) * uniforms.inner * ${i}u`,A=`f32(${_.getByOffset(z)})`,v=i===2?`f32(${_.getByOffset(`${z} + 1u`)})`:"0.0";return`vec2<f32>(${A}, ${v})`},S;if(n&&s){let E=Math.floor(r/2)+1,z=r%2===0?`select(provided, provided - 1u, provided == ${E}u)`:"provided";S=`
    ...
    workgroupBarrier();`;let{code:x,resultOffset:b}=nl(h,r,l),k=p===1?`smem[${b}u + i]`:`smem[${b}u + i] * ${ft(p)}`,T=a===2?y.setByOffset("off + 1u",`${u}(v.y)`):"";return`
  ${na(g,_,y)}
...
${x}    for (var i = local_idx; i < uniforms.outputLength; i += ${it}u) {
  ...
  }`};return{name:"DFT",shaderCache:{hint:ia(e,"fft"),inputDependencies:["type"]},getShaderSource:c,getRunData:()=>({outputs:[{dims:e.outputDims,dataType:t}],programUniforms:aa(e),dispatchGroup:{x:e.batch}})}},ul=e=>{let{dataType:t,length:r,inputComponents:i,outputComponents:a,inverse:n,onesided:s}=e,u=Ie(t),l=n?1:-1,p=n?1/r:1,h=c=>{let g=M("x",t,[1]),_=Z("y",t,[1]),y=k=>{let T=`inBase + (${k}) * uniforms.inner * ${i}u`,E=`f32(${g.getByOffset(T)})`,z=i===2?`f32(${g.getByOffset(`${T} + 1u`)})`:"0.0";return`vec2<f32>(${E}, ${z})`},w=n&&s?`fn spectrum(inBase: u32, k: u32) -> vec2<f32> {
...
`)};
          ...
          }`};return{name:"Einsum",shaderCache:{hint:r.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let p=u.filter(c=>r.symbolToInfo.has(c)).map(c=>({type:12,data:r.symbolToInfo.get(c)?.dimValue||0}));p.push({type:12,data:n});let h=e.map((c,g)=>[...Q(c)]).reduce((c,g)=>c.concat(g),p);return h.push(...Q(i)),{outputs:[{dims:i,dataType:t}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:h}},getShaderSource:l}},wh=(e,t)=>{let r=new hl(e.inputs,t.equation),i=r.outputDims,a=e.inputs.map((n,s)=>n.dims);e.compute(fl(a,e.inputs[0].dataType,r,i))},$h=e=>{let t=e.equation.replace(/\s+/g,"");return he({equation:t})}}),ml,la,gl,yl,vh,F0=q(()=>{"use strict";re(),ie(),ae(),ml=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),i=r.length<t.length?0:r.length-t.length,a=t.length<r.length?0:t.length-r.length;for(;i<r.length&&a<t.length;++i,++a)if(r[i]!==t[a]&&r[i]!==1&&t[a]!==1)throw new Error("Expand requires shape to be broadcastable to input")},la=(e,t)=>{let r=e.length-t.length,i=[];for(let a=0;a<r;++a)i.push(e[a]);for(let a=0;a<t.length;++a)i.push(t[a]===1?e[a+r]:t[a]);return i},gl=(e,t)=>e.length>t.length?la(e,t):la(t,e),yl=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),i=gl(t,r),a=e[0].dataType,n=a===9||R.size(t)===1,s=a===9||t.length>0&&t[t.length-1]%4===0?4:1,u=n||i.length>0&&i[i.length-1]%4===0?4:1,l=Math.ceil(R.size(i)/u),p=c=>{let g=M("input",a,t.length,s),_=Z("output",a,i.length,u),y;if(a===9){let w=(S,x,b="")=>`
    ...
    ${y}`},h=[{type:12,data:l},...Q(t,i)];return{name:"Expand",shaderCache:{hint:`${i.length};${s}${u}`,inputDependencies:["rank"]},getShaderSource:p,getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:h})}},vh=e=>{ml(e.inputs),e.compute(yl(e.inputs),{inputs:[0]})}}),_l,xh,j0=q(()=>{"use strict";re(),ie(),ae(),sn(),_l=e=>{let t=e[0].dataType,r=R.size(e[0].dims),i=R.size(e[1].dims),a=i%4===0,n=s=>{let u=M("x",t,[1],4),l=M("bias",t,[1],4),p=Z("y",t,[1],4),h=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],c=_=>`
    ...
    ${s.mainStart(Ft)}
      ...
      ${g.mainStart()}
        ...
        ${x}
      }`};return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:s,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:h}),getShaderSource:c}},Sh=e=>he({axis:e.axis}),Th=(e,t)=>{let r=e.inputs;bl(r),e.compute(wl(e.inputs,t))}}),$l,kh,Ih,Z0=q(()=>{"use strict";re(),ie(),ae(),$l=(e,t,r,i,a,n,s,u,l)=>{let p=[{type:12,data:n},{type:12,data:i},{type:12,data:a},{type:12,data:r},{type:12,data:s},{type:12,data:u},{type:12,data:l}],h=[n];p.push(...Q(t.dims,h));let c=g=>{let _=M("indices_data",t.dataType,t.dims.length),y=Z("input_slice_offsets_data",12,1,1),w=[_,y],S=[{name:"output_size",type:"u32"},{name:"batch_dims",type:"u32"},{name:"input_dims",type:"u32",length:a.length},{name:"sizes_from_slice_dims_data",type:"u32",length:r.length},{name:"num_slices_per_batch",type:"u32"},{name:"input_batch_stride",type:"u32"},{name:"num_slice_dims",type:"u32"}];return`
  ...
  ${g.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((_,y)=>y!==1).map(_=>_.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(_,y)=>"rank")},getRunData:()=>({outputs:[{dims:u,dataType:p}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:c}),getShaderSource:g}},Eh=(e,t)=>{let r=e.inputs;vl(r,t),e.compute(xl(e.inputs,t))},zh=e=>he({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),Sl,Tl,Ch,Ah,Q0=q(()=>{"use strict";re(),ie(),Te(),ae(),Sl=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)},Tl=(e,t)=>{let r=e[0].dims,i=e[0].dataType,a=r.length,n=e[1].dims,s=e[1].dataType,u=R.normalizeAxis(t.axis,a),l=r[u],p=n.slice(0),h=R.size(p),c=M("input",i,a),g=M("indicesInput",s,n.length),_=Z("output",i,p.length),y=[{type:12,data:h},{type:6,data:l},{type:12,data:u}];return y.push(...Q(r,n,p)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:p,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:y}),getShaderSource:w=>`
...
`,Ml=(e,t,r)=>(()=>{switch(r.mode){case"nearest":return`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:u,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:p}),getShaderSource:h},{inputs:[t,r],outputs:[-1]})[0]},hr=(e,t,r,i,a,n,s,u)=>{let l=n;if(s&&R.size(s.dims)>0){if(i===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return l=Nl(e,n,s,t,i,r*a,u),l=l.reshape([t,i,r,a]),r===1||i===1?l:e.compute(Ue(l,da.perm),{inputs:[l],outputs:[-1]})[0]}else return n.dims.length===3&&(l=n.reshape([t,i,r,a])),r===1||i===1?l:e.compute(Ue(l,da.perm),{inputs:[l],outputs:[-1]})[0]},Nh=(e,t)=>{let r=Dl(e.inputs,t),i=e.inputs[0],a=Re(e.inputs,1),n=Re(e.inputs,2),s=Re(e.inputs,3),u=Re(e.inputs,4),l=Re(e.inputs,5),p=Re(e.inputs,6),h=Re(e.inputs,7);if(i.dims.length===5)throw new Error("Packed QKV is not implemented");if(a?.dims.length===5)throw new Error("Packed KV is not implemented");let c=a&&n&&a.dims.length===4&&n.dims.length===4,g=hr(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,i,s,0);if(c)return gr(e,g,a,n,u,void 0,p,h,l,r);if(!a||!n)throw new Error("key and value must be provided");let _=hr(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,a,s,r.hiddenSize),y=hr(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,n,s,2*r.hiddenSize);gr(e,g,_,y,u,void 0,p,h,l,r)}}),Ul,Pl,ql,Ll,La,Ph,qh,Lh=q(()=>{"use strict";re(),ie(),Te(),ae(),Ul=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Pl=(e,t)=>{let r=[],i=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(a=>r.push(Number(a))),i=r.length),he({numOutputs:i,axis:t.axis,splitSizes:r})},ql=e=>`
fn calculateOutputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
      ...
      fn writeBufferData(output_number: u32, indices: ${e[0].type.indices}, global_idx: u32) {
        ${r.join(`
`)}
      }`},La=(e,t)=>{let r=e[0].dims,i=R.size(r),a=e[0].dataType,n=R.normalizeAxis(t.axis,r.length),s=new Array(t.numOutputs),u=M("input",a,r.length),l=new Array(t.numOutputs),p=[],h=[],c=0,g=[{type:12,data:i}];for(let y=0;y<t.numOutputs;y++){c+=t.splitSizes[y],l[y]=c;let w=r.slice();w[n]=t.splitSizes[y],h.push(w),s[y]=Z(`output${y}`,a,w.length),p.push({dims:h[y],dataType:e[0].dataType})}g.push({type:12,data:l},...Q(r,...h));let _=y=>`
  ...
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getShaderSource:_,getRunData:()=>({outputs:p,dispatchGroup:{x:Math.ceil(i/64)},programUniforms:g})}},Ph=(e,t)=>{Ul(e.inputs);let r=e.inputs.length===1?t:Pl(e.inputs,t);e.compute(La(e.inputs,r),{inputs:[0]})},qh=e=>{let t=e.axis,r=e.splitSizes,i=e.numOutputs<0?r.length:e.numOutputs;if(i!==r.length)throw new Error("numOutputs and splitSizes length must be equal");return he({axis:t,numOutputs:i,splitSizes:r})}}),Wl,Jr,Wh,Vh=q(()=>{"use strict";re(),ie(),Te(),ae(),Wl=(e,t)=>{let[r,i,a,n]=e,{numHeads:s,rotaryEmbeddingDim:u}=t;if(r.dims.length!==3&&r.dims.length!==4)throw new Error(`Input 'x' is expected to have 3 or 4 dimensions, got ${r.dims.length}`);if(!R.areEqual(i.dims,[])&&!R.areEqual(i.dims,[1])&&i.dims.length!==2)throw new Error(`Input 'position_ids' is expected to have 0, 1, or 2 dimensions, got ${i.dims.length}`);if(a.dims.length!==2)throw new Error(`Input 'cos_cache' is expected to have 2 dimensions, got ${a.dims.length}`);if(n.dims.length!==2)throw new Error(`Input 'sin_cache' is expected to have 2 dimensions, got ${n.dims.length}`);if(!R.areEqual(a.dims,n.dims))throw new Error("Inputs 'cos_cache' and 'sin_cache' are expected to have the same shape");if(u>0&&s===0)throw new Error("num_heads must be provided if rotary_embedding_dim is specified");let l=r.dims[0],p=r.dims[r.dims.length-2],h=a.dims[0],c=R.sizeFromDimension(r.dims,1)/p,g=u===0?a.dims[1]*2:c/s;if(u>g)throw new Error("rotary_embedding_dim must be less than or equal to head_size");if(i.dims.length===2){if(l!==i.dims[0])throw new Error(`Input 'position_ids' dimension 0 should be of size batch_size, got ${i.dims[0]}`);if(p!==i.dims[1])throw new Error(`Input 'position_ids' dimension 1 should be of size sequence_length, got ${i.dims[1]}`)}if(p>h)throw new Error("Updating cos_cache and sin_cache in RotaryEmbedding is not currently supported");if(g/2!==a.dims[1]&&u/2!==a.dims[1])throw new Error(`Input 'cos_cache' dimension 1 should be same as head_size / 2 or rotary_embedding_dim / 2, got ${a.dims[1]}`)},Jr=(e,t)=>{let{interleaved:r,numHeads:i,rotaryEmbeddingDim:a,scale:n}=t,s=e[0].dims[0],u=R.sizeFromDimension(e[0].dims,1),l=e[0].dims[e[0].dims.length-2],p=u/l,h=e[2].dims[1],c=a===0?h*2:p/i,g=new Array(s,l,p/c,c-h),_=R.computeStrides(g),y=[{type:1,data:n},{type:12,data:g},{type:12,data:_},...e[0].dims.length===3?new Array({type:12,data:[u,p,c,1]}):[],...e[0].dims.length===4?new Array({type:12,data:[u,c,l*c,1]}):[],...Q(e[0].dims,e[1].dims,e[2].dims,e[3].dims,e[0].dims)],w=S=>{let x=M("input",e[0].dataType,e[0].dims.length),b=M("position_ids",e[1].dataType,e[1].dims.length),k=M("cos_cache",e[2].dataType,e[2].dims.length),T=M("sin_cache",e[3].dataType,e[3].dims.length),E=Z("output",e[0].dataType,e[0].dims.length);return S.registerUniforms([{name:"scale",type:"f32"},{name:"global_shape",type:"u32",length:g.length},{name:"global_strides",type:"u32",length:_.length},{name:"input_output_strides",type:"u32",length:_.length}]),`
  ...
  }`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${l};${u};${g}`,inputDependencies:w},getRunData:()=>({outputs:[{dims:y,dataType:1}],dispatchGroup:{x:c},programUniforms:S}),getShaderSource:x},{inputs:[t,r,i],outputs:[-1]})[0]},Fl=(e,t,r)=>{let i=t[0].dims,a=i,n=2,s=i[0],u=i[1],l=R.sizeFromDimension(i,n),p=Se(l),h=R.size(a)/p,c=ca(e,t[0],t[1],t[2],s,l,u,r.epsilon),g=[s,u,l/p],_=[s,u],y=["type","none"],w=S=>{let x=M("x",t[0].dataType,g.length,p),b=M("scale_shift",1,_.length,2),k=Z("output",t[0].dataType,g.length,p),T=[x,b,k];return`
  ...
  }`};e.compute({name:"InstanceNormalization",shaderCache:{hint:`${p}`,inputDependencies:y},getRunData:()=>({outputs:[{dims:a,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:[{type:12,data:h},...Q(g,_,g)]}),getShaderSource:w},{inputs:[t[0],c]})},jl=(e,t,r)=>{let i=t[0].dims,a=i,n=i[0],s=i[i.length-1],u=R.sizeFromDimension(i,1)/s,l=Se(s),p=R.size(a)/l,h=[{type:12,data:u},{type:12,data:Math.floor(s/l)}],c=["type","type"],g=!1,_=[0,i.length-1];for(let x=0;x<i.length-2;x++)g=g||i[x+1]!==1,_.push(x+1);g=g&&i[i.length-1]!==1;let y=g?e.compute(Ue(e.inputs[0],_),{inputs:[e.inputs[0]],outputs:[-1]})[0]:e.inputs[0].reshape(Array.from({length:i.length},(x,b)=>i[_[b]])),w=ca(e,y,t[1],t[2],n,u,s,r.epsilon),S=x=>{let b=Ee(t[0].dataType),k=l===1?"vec2f":`mat${l}x2f`,T=A=>{let v=A===0?"x":"y",N=l===1?"f32":`vec${l}f`;switch(l){case 1:return`${b}(${N}(scale.${v}))`;case 2:return`vec2<${b}>(${N}(scale[0].${v}, scale[1].${v}))`;case 4:return`vec4<${b}>(${N}(scale[0].${v}, scale[1].${v}, scale[2].${v}, scale[3].${v}))`;default:throw new Error(`Not supported compoents ${l}`)}},E=M("input",t[0].dataType,t[0].dims,l),z=Z("output",t[0].dataType,a,l);return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${l}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:a,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:h}),getShaderSource:S},{inputs:[t[0],w]})},Hh=(e,t)=>{t.format==="NHWC"?jl(e,e.inputs,t):Fl(e,e.inputs,t)}}),Kl,Zl,Fh,ry=q(()=>{"use strict";re(),ie(),ae(),Kl=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Zl=(e,t,r)=>{let i=t.simplified,a=e[0].dims,n=e[1],s=!i&&e[2],u=a,l=R.normalizeAxis(t.axis,a.length),p=R.sizeToDimension(a,l),h=R.sizeFromDimension(a,l),c=R.size(n.dims),g=s?R.size(s.dims):0;if(c!==h||s&&g!==h)throw new Error(`Size of X.shape()[axis:] == ${h}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${c} and bias size of ${g}`);let _=[];for(let E=0;E<a.length;++E)E<l?_.push(a[E]):_.push(1);let y=Se(h),w=["type","type"],S=[{type:12,data:p},{type:1,data:h},{type:12,data:Math.floor(h/y)},{type:1,data:t.epsilon}];s&&w.push("type");let x=r>1,b=r>2,k=E=>{let z=Ee(e[0].dataType),A=[M("x",e[0].dataType,e[0].dims,y),M("scale",n.dataType,n.dims,y)];s&&A.push(M("bias",s.dataType,s.dims,y)),A.push(Z("output",e[0].dataType,u,y)),x&&A.push(Z("mean_data_output",1,_)),b&&A.push(Z("inv_std_output",1,_));let v=[{name:"norm_count",type:"u32"},{name:"norm_size",type:"f32"},{name:"norm_size_vectorized",type:"u32"},{name:"epsilon",type:"f32"}];return`
  ...
  ${E.mainStart()}
    ...
    ${b?"inv_std_output[global_idx] = inv_std_dev":""};
          ...
          `;for(let ve=0;ve<_*w;ve++)K+=`
            ...
            b_dequantized_values = ${c===1?`${J}(${Array.from({length:8},(ze,me)=>`(b_quantized_values[${me}] - ${V?`zero_point${ve}`:"zero_point"}) * scale${ve}`).join(", ")});`:`(b_quantized_values - ${J}(${Array(8).fill(`${V?`zero_point${ve}`:"zero_point"}`).join(",")})) * scale${ve};`};
            workgroup_shared[local_id.x * ${w} + ${Math.floor(ve/_)}]${_>1?`[${ve%_}]`:""} += ${Array.from({length:8/c},(ze,me)=>`${c===1?`a_data${F>0?F:""}[${me}] * b_dequantized_values[${me}]`:`dot(a_data${F>0?F:""}[${me}], b_dequantized_values[${me}])`}`).join(" + ")};
          `}return K},D=()=>{let K=`
            var col_index = col * ${_};
            ${V?`
        ...
        }`};return{name:"MatMulNBits",shaderCache:{hint:`${t.blockSize};${t.bits};${c};${g};${_};${w};${x}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:y,dataType:h}],dispatchGroup:{x:S},programUniforms:b}),getShaderSource:z}},Jl=(e,t)=>{let r=e[0].dims,i=r.length,a=r[i-2],n=t.k,s=t.n,u=r.slice(0,i-2),l=R.size(u),p=e[1].dims[2]/4,h=e[0].dataType,c=Se(t.k),g=Se(p),_=u.concat([a,s]),y=128,w=s%8===0?8:s%4===0?4:1,S=y/w,x=Math.floor(32/t.bits),b=S*g*x,k=b/c,T=b/t.blockSize,E=R.size(_)/w,z=[],A=[l,a,n/c],v=R.convertShape(e[1].dims).slice();v.splice(-1,1,p/g),z.push(...Q(A)),z.push(...Q(v)),z.push(...Q(e[2].dims)),e.length===4&&z.push(...Q(R.convertShape(e[3].dims)));let N=[l,a,s];z.push(...Q(N));let L=H=>{let P=A.length,V=M("a",e[0].dataType,P,c),Y=M("b",12,v.length,g),C=M("scales",e[2].dataType,e[2].dims.length),U=[V,Y,C],J=e.length===4?M("zero_points",12,e[3].dims.length):void 0;J&&U.push(J);let te=N.length,j=Z("output",e[0].dataType,te),ne=Ee(e[0].dataType),D=()=>{switch(c){case 1:return`
          ...
          `},nd=(e,t,r)=>{switch(r.mode){case 0:return td(e,t,r.pads.length);case 1:return rd(e,t,r.pads.length);case 2:return id(e,t,r.pads.length);case 3:return ad(e,t,r.pads.length);default:throw new Error("Invalid mode")}},sd=(e,t)=>{let r=R.padShape(e[0].dims.slice(),t.pads),i=e[0].dims,a=R.size(r),n=[{type:12,data:a},{type:6,data:t.pads}],s=e.length>=3&&e[2].data;t.mode===0&&n.push({type:s?e[2].dataType:1,data:t.value}),n.push(...Q(e[0].dims,r));let u=["rank"],l=p=>{let h=Z("output",e[0].dataType,r.length),c=M("x",e[0].dataType,i.length),g=c.type.value,_=nd(h,i.length,t),y=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&y.push({name:"constant_value",type:s?g:"f32"}),`
            ...
            output[global_idx] = value;
                ...
                for (var i: u32 = 0u; i < uniforms.kw; i++) {
                  ...
                  let x_val = x[${t.indicesToOffset("xIndices")}];
                  ${n}
                }`,a.kernelShape.length===2){let k=r-(g?3:2);c?S=`
    ...
    `,u="",l=M("x",t.dataType,t.dims.length),p=["rank"],[h,c,g,_,y]=fa(n,a);return h.push(...Q(t.dims,n)),{name:e,shaderCache:{hint:`${i.cacheKey};${g};${_};${y}`,inputDependencies:p},getRunData:()=>({outputs:[{dims:n,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(R.size(n)/64)},programUniforms:h}),getShaderSource:w=>ma(w,l,t.dims.length,n.length,a,s,u,t.dataType===10?-65504:-1e5,c,g,_,y)}},tf=(e,t)=>{or(e.inputs),e.compute(wa("MaxPool",e.inputs[0],!1,t))},rf=e=>{let t=e.storage_order,r=e.dilations,i=ya(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(i.ceilMode!==0)throw new Error("ceil_mode output-shape is computed, but ceil_mode kernel execution (padding) is not yet implemented in the WebGPU MaxPool kernel");let a={storageOrder:t,dilations:r,...i,cacheKey:""};return{...a,cacheKey:ld(a)}},af=e=>{let t=e.format;return{format:t,...ba,cacheKey:t}},nf=(e,t)=>{or(e.inputs),e.compute(wa("GlobalMaxPool",e.inputs[0],!0,t))}}),dd,pd,sf,of,oy=q(()=>{"use strict";re(),ie(),Te(),ae(),dd=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,i)=>r===e[2].dims[i]).reduce((r,i)=>r&&i,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((a,n)=>n===t.axis||a===e[0].dims[n]).reduce((a,n)=>a&&n,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],i=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/i)||t.blockSize>Math.ceil(r/(i-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},pd=(e,t)=>{let r=R.normalizeAxis(t.axis,e[0].dims.length),i=e[0].dataType,a=i===3,n=e[0].dims,s=e[1].dataType,u=R.size(n),l=i===3||i===2,p=l?[Math.ceil(R.size(e[0].dims)/4)]:e[0].dims,h=e[1].dims,c=e.length>2?e[2]:void 0,g=c?l?[Math.ceil(R.size(c.dims)/4)]:c.dims:void 0,_=h.length===0||h.length===1&&h[0]===1,y=_===!1&&h.length===1,w=Se(u),S=_&&(!l||w===4),x=S?w:1,b=S&&!l?w:1,k=M("input",l?12:i,p.length,b),T=M("scale",s,h.length),E=c?M("zero_point",l?12:i,g.length):void 0,z=Z("output",s,n.length,x),A=[k,T];E&&A.push(E);let v=[p,h];c&&v.push(g);let N=[{type:12,data:u/x},{type:12,data:r},{type:12,data:t.blockSize},...Q(...v,n)],L=H=>{let P=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      ${z.setByOffset("global_idx",`${z.type.value}(x_value - zero_point_value) * scale_value`)};
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:E?["rank","rank","rank"]:["rank","rank"]},getShaderSource:L,getRunData:()=>({outputs:[{dims:n,dataType:s}],dispatchGroup:{x:Math.ceil(u/x/64),y:1,z:1},programUniforms:N})}},sf=(e,t)=>{dd(e.inputs,t),e.compute(pd(e.inputs,t))},of=e=>he({axis:e.axis,blockSize:e.blockSize})}),cd,hd,uf,uy=q(()=>{"use strict";Le(),re(),ae(),cd=(e,t,r)=>{let i=e===t,a=e<t&&r<0,n=e>t&&r>0;if(i||a||n)throw new Error("Range these inputs' contents are invalid.")},hd=(e,t,r,i)=>{let a=Math.abs(Math.ceil((t-e)/r)),n=[a],s=a,u=[{type:12,data:s},{type:i,data:e},{type:i,data:r},...Q(n)],l=p=>{let h=Z("output",i,n.length),c=h.type.value,g=[{name:"outputSize",type:"u32"},{name:"start",type:c},{name:"delta",type:c}];return`
        ...
        output[global_idx] = uniforms.start + ${c}(global_idx) * uniforms.delta;
              ...
              ${a}bitcast<${i}>(oldValue) + (${r})${n}`;case"max":return i==="i32"||i==="u32"?`atomicMax(&${t}, bitcast<${i}>(${r}));`:`
                ${a}max(bitcast<f32>(oldValue), (${r}))${n}`;case"min":return i==="i32"||i==="u32"?`atomicMin(&${t}, bitcast<${i}>(${r}));`:`${a}min(bitcast<${i}>(oldValue), (${r}))${n}`;case"mul":return`${a}(bitcast<${i}>(oldValue) * (${r}))${n}`;default:throw new Error(`Reduction ${e} is not supported.`)}},md=(e,t)=>{let r=e[0].dims,i=e[1].dims,a=r,n=1,s=Math.ceil(R.sizeToDimension(i,i.length-1)/n),u=i[i.length-1],l=R.sizeFromDimension(r,u),p=[{type:12,data:s},{type:12,data:u},{type:12,data:l},...Q(e[1].dims,e[2].dims,a)],h=c=>{let g=M("indices",e[1].dataType,e[1].dims.length),_=M("updates",e[2].dataType,e[2].dims.length,n),y=t.reduction!=="none"&&t.reduction!==""?Mp("output",e[0].dataType,a.length):Z("output",e[0].dataType,a.length,n);return`
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${fd(t.reduction,"output[data_offset + i]","value",y.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:p}),getShaderSource:h}},lf=e=>he({reduction:e.reduction}),df=(e,t)=>{e.compute(md(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),gd,yd,_d,$a,bd,wd,$d,vd,xd,Sd,Td,kd,va,Id,Ed,zd,Cd,Ad,pf,cf,dy=q(()=>{"use strict";re(),ie(),Te(),ae(),gd=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
            one outermost scale values equal to 1, or 5D with two outermost scale values equal to 1`)}else if(t.mode==="cubic"&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},yd=(e,t,r)=>{t.every(a=>a>=0&&a<r||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let i=new Array(r).fill(1);return t.forEach((a,n)=>i[a]=e[n]),i},_d=(e,t,r,i,a,n)=>{let[s,u,l]=r>10?[1,2,3]:[-1,e.length>1?1:-1,-1],p=e[0].dims.length;if(s>0&&e.length>s&&e[s].dims.length>0)e[s].getFloat32Array().forEach(h=>n.push(h));else if(t.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(u>0&&e.length>u&&e[u].dims.length===1&&e[u].dims[0]>0){if(e[u].getFloat32Array().forEach(h=>i.push(h)),i.length!==0&&i.length!==p&&r>=18&&i.length!==t.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");gd(i,t),t.axes.length>0&&yd(i,t.axes,p).forEach((h,c)=>i[c]=h)}if(l>0&&e.length>l&&e[l].dims.length===1&&e[l].dims[0]>0&&(e[l].getBigInt64Array().forEach(h=>a.push(Number(h))),a.length!==0&&a.length!==p&&r>=18&&a.length!==t.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(t.axes.length>0){if(i.length!==0&&i.length!==t.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(a.length!==0&&a.length!==t.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof i<"u"&&typeof a<"u"&&i.length>0&&a.length>p)throw new Error("Resize requires only of scales or sizes to be specified")},$a=(e,t,r,i)=>`
...
`:"",Id=(e,t,r,i,a)=>{let[n,s,u,l]=r.length===2?[-1,0,1,-1]:[0,2,3,1],p=e.type.value;return`
    ...
    }`},Ed=(e,t,r,i,a,n,s,u,l,p)=>{let h=r.length===2,c=!0,[g,_]=h?[0,1]:c?[2,3]:[1,2],y=e.type.value,w=S=>{let x=S===g?"row":"col";return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${y} {
    ...
    `},zd=(e,t,r,i,a)=>{let[n,s,u,l,p]=r.length===3?[-1,0,1,2,-1]:[0,2,3,4,1],h=e.type.value;return`
    ...
    }`},Cd=(e,t,r,i,a,n)=>{let s=e.dims,u=$d(n,t.axes,s.length),l=vd(s,i,a,t.axes),p=i.slice();i.length===0&&(p=s.map((b,k)=>b===0?1:l[k]/b),t.keepAspectRatioPolicy!=="stretch"&&(l=xd(s,p,t)));let h=Z("output",e.dataType,l.length),c=M("input",e.dataType,s.length),g=R.size(l),_=s.length===l.length&&s.every((b,k)=>b===l[k]),y=t.coordinateTransformMode==="tf_crop_and_resize",w=t.extrapolationValue,S=c.type.value,x=b=>`
      ${_?"":`
      ${bd(t.coordinateTransformMode,S)};
      ${(()=>{switch(t.mode){case"nearest":return`
              ${kd(c,s)};
              ${wd(t.nearestMode,r,S)};
              ${Td(c,h,s,l,p.length,u.length,y)};
              `;case"linear":return`
              ${Sd(h,s,l,p.length,u.length)};
              ${(()=>{if(s.length===2||s.length===4)return`${Id(c,h,s,y,w)}`;if(s.length===3||s.length===5)return`${zd(c,h,s,y,w)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
            `;case"cubic":return`
            ${(()=>{if(s.length===2||s.length===4)return`${Ed(c,h,s,l,p,u,t.cubicCoeffA,y,t.extrapolationValue,t.excludeOutside)}`;throw Error("Cubic mode only supports input dims 2 and 4 are supported in linear mode.")})()};
...
`}
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${l.length}_${s.length}_${n.length}`,inputDependencies:["rank"]},getShaderSource:S,getRunData:()=>({outputs:[h],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:w})}},ff=(e,t)=>{Md(e.inputs,t);let r=Bd(e.inputs,t);e.compute(Nd(e.inputs,r),{inputs:[0]})},mf=e=>{let t=e.starts,r=e.ends,i=e.axes;return he({starts:t,ends:r,axes:i})}}),Ud,Pd,gf,yf,hy=q(()=>{"use strict";re(),ie(),Te(),bt(),ae(),Ud=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Pd=(e,t)=>{let r=e.inputs[0],i=r.dims,a=R.size(i),n=i.length,s=R.normalizeAxis(t.axis,n),u=s<i.length-1,l,p=[];u?(p=Array.from({length:n},(A,v)=>v),p[s]=n-1,p[n-1]=s,l=e.compute(Ue(r,p),{inputs:[r],outputs:[-1]})[0]):l=r;let h=l.dims,c=h[n-1],g=a/c,_=Se(c),y=c/_,w=64;g===1&&(w=256);let S=(A,v)=>v===4?`max(max(${A}.x, ${A}.y), max(${A}.z, ${A}.w))`:v===2?`max(${A}.x, ${A}.y)`:v===3?`max(max(${A}.x, ${A}.y), ${A}.z)`:A,x=M("x",l.dataType,l.dims,_),b=Z("result",l.dataType,l.dims,_),k=x.type.value,T=Ee(l.dataType)==="f32"?`var threadMax = ${k}(-3.4028234663852886e+38f);`:`var threadMax = ${k}(-65504.0h);`,E=A=>`
    ...
    }`;return{name:"Tile",shaderCache:{hint:`${i}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:[{type:12,data:n},...Q(e[0].dims,a)]}),getShaderSource:p}},_f=e=>{qd(e.inputs),e.compute(Wd(e.inputs),{inputs:[0]})}}),Vd,Gd,bf,my=q(()=>{"use strict";re(),ie(),ae(),Vd=(e,t,r,i,a)=>{let n=Z("output_data",a,r.length,4),s=M("a_data",t[1].dataType,t[1].dims.length,4),u=M("b_data",t[2].dataType,t[2].dims.length,4),l=M("c_data",t[0].dataType,t[0].dims.length,4),p,h=(c,g,_)=>`select(${g}, ${c}, ${_})`;if(!i)p=n.setByOffset("global_idx",h(s.getByOffset("global_idx"),u.getByOffset("global_idx"),l.getByOffset("global_idx")));else{let c=(g,_,y="")=>{let w=`a_data[index_a${_}][component_a${_}]`,S=`b_data[index_b${_}][component_b${_}]`,x=`bool(c_data[index_c${_}] & (0xffu << (component_c${_} * 8)))`;return`
...
`).map(t=>t.trim()).filter(Boolean)}async function Lf(e,t,r){let i=typeof self<"u"&&self.location?self.location.origin+"/ort/":"/ort/";ge.wasm.wasmPaths=i,ge.wasm.numThreads=1,t==="webgpu"&&(ge.wasm.proxy=!1);let n=(await ky())[e];if(!n)throw new Error(`Unknown model scale: ${e}`);let s=await qf(n.det,(_,y)=>{r({stage:"download_det",loaded:_,total:y||n.detSizeBytes,percent:y?_/y*50:25,modelScale:e})}),u=await qf(n.rec,(_,y)=>{r({stage:"download_rec",loaded:_,total:y||n.recSizeBytes,percent:50+(y?_/y*40:20),modelScale:e})});r({stage:"init_session",loaded:0,total:1,percent:90,modelScale:e});let l={executionProviders:[t]},[p,h]=await Promise.all([yr.create(new Uint8Array(s),l),yr.create(new Uint8Array(u),l)]),c="";try{let _=await caches.open(bn),y=await _.match(n.dict);if(y)c=await y.text();else{let w=await fetch(n.dict);if(!w.ok)throw new Error(`Cannot load dict: ${w.status}`);c=await w.text(),await _.put(n.dict,new Response(c,{headers:{"content-type":"text/plain"}}))}}catch{let _=await fetch(n.dict);if(!_.ok)throw new Error(`Cannot load dict: ${_.status}`);c=await _.text()}let g=Iy(c);return r({stage:"init_session",loaded:1,total:1,percent:100,modelScale:e}),{detSession:p,recSession:h,dict:g,entry:n}}var Kt=[.485,.456,.406],Zt=[.229,.224,.225];function Wf(e){let{width:t,height:r,data:i}=e,a=Math.min(960/Math.max(t,r),1),n=Math.round(t*a),s=Math.round(r*a);n=Math.ceil(n/32)*32,s=Math.ceil(s/32)*32;let u=n/t,l=s/r,h=new OffscreenCanvas(n,s).getContext("2d"),c=new OffscreenCanvas(t,r);c.getContext("2d").putImageData(e,0,0),h.drawImage(c,0,0,n,s);let _=h.getImageData(0,0,n,s).data,y=new Float32Array(3*s*n),w=s*n;for(let S=0;S<w;S++){let x=_[S*4]/255,b=_[S*4+1]/255,k=_[S*4+2]/255;y[0*w+S]=(x-Kt[0])/Zt[0],y[1*w+S]=(b-Kt[1])/Zt[1],y[2*w+S]=(k-Kt[2])/Zt[2]}return{tensor:y,inputH:s,inputW:n,scaleH:l,scaleW:u}}function Vf(e,t){let[r,i,a,n]=t,s=Math.hypot(i[0]-r[0],i[1]-r[1]),u=Math.hypot(a[0]-n[0],a[1]-n[1]),l=Math.hypot(n[0]-r[0],n[1]-r[1]),p=Math.hypot(a[0]-i[0],a[1]-i[1]),h=Math.round(Math.max(s,u)),c=Math.round(Math.max(l,p)),g=Math.min(h,4096),_=48,y=Math.max(1,Math.round(g*(_/Math.max(c,1)))),w=new OffscreenCanvas(e.width,e.height);w.getContext("2d").putImageData(e,0,0);let b=new OffscreenCanvas(y,_).getContext("2d"),k=t.map(P=>P[0]),T=t.map(P=>P[1]),E=Math.max(0,Math.floor(Math.min(...k))),z=Math.max(0,Math.floor(Math.min(...T))),A=Math.min(e.width,Math.ceil(Math.max(...k))),v=Math.min(e.height,Math.ceil(Math.max(...T)));b.drawImage(w,E,z,A-E,v-z,0,0,y,_);let N=b.getImageData(0,0,y,_).data,L=_*y,H=new Float32Array(3*L);for(let P=0;P<L;P++){let V=N[P*4]/255,Y=N[P*4+1]/255,C=N[P*4+2]/255;H[0*L+P]=(V-Kt[0])/Zt[0],H[1*L+P]=(Y-Kt[1])/Zt[1],H[2*L+P]=(C-Kt[2])/Zt[2]}return{tensor:H,width:y}}function Gf(e,t,r,i,a){let n=new Uint8Array(t*r);for(let p=0;p<n.length;p++)n[p]=e[p]>=.2?1:0;let s=Ey(n,t,r),u=[],l=new Uint8Array(t*r);for(let p=0;p<t;p++)for(let h=0;h<r;h++){let c=p*r+h;if(!s[c]||l[c])continue;let g=[],_=[c];for(l[c]=1;_.length;){let Y=_.pop(),C=Math.floor(Y/r),U=Y%r;g.push([U,C]);for(let[J,te]of[[C-1,U],[C+1,U],[C,U-1],[C,U+1]]){if(J<0||J>=t||te<0||te>=r)continue;let j=J*r+te;!s[j]||l[j]||(l[j]=1,_.push(j))}}if(g.length<16)continue;let y=1/0,w=1/0,S=-1/0,x=-1/0,b=0;for(let[Y,C]of g)Y<y&&(y=Y),Y>S&&(S=Y),C<w&&(w=C),C>x&&(x=C),b+=e[C*r+Y];let k=b/g.length;if(k<.4)continue;let T=S-y,E=x-w;if(T<4||E<4)continue;let z=(T*1.4-T)/2,A=(E*1.4-E)/2,v=Math.max(0,y-z),N=Math.max(0,w-A),L=Math.min(r-1,S+z),H=Math.min(t-1,x+A),P=Y=>Y*a,V=Y=>Y*i;u.push({score:k,points:[[P(v),V(N)],[P(L),V(N)],[P(L),V(H)],[P(v),V(H)]]})}return u}function Ey(e,t,r){let i=new Uint8Array(t*r);for(let a=0;a<t;a++)for(let n=0;n<r;n++){let s=0;e:for(let u=-1;u<=1;u++)for(let l=-1;l<=1;l++){let p=a+u,h=n+l;if(p>=0&&p<t&&h>=0&&h<r&&e[p*r+h]){s=1;break e}}i[a*r+n]=s}return i}function Hf(e,t,r,i){let a="",n=0,s=0,u=-1;for(let l=0;l<t;l++){let p=-1/0,h=0,c=l*r;for(let y=0;y<r;y++)e[c+y]>p&&(p=e[c+y],h=y);let g=0;for(let y=0;y<r;y++)g+=Math.exp(e[c+y]-p);let _=1/g;if(h!==0&&h!==u){let y=i[h-1]??"?";a+=y,n+=_,s++}u=h}return{text:a,confidence:s>0?n/s:0}}var ii=null;async function zy(e){try{ii=await Lf(e.modelScale,e.backend,r=>{self.postMessage({type:"PROGRESS",...r})}),self.postMessage({type:"READY",modelScale:e.modelScale})}catch(t){let r=t instanceof Error?t.message:String(t);self.postMessage({type:"ERROR",message:r})}}async function Cy(e){if(!ii){self.postMessage({type:"ERROR",message:"[OCR] Model not loaded"});return}let t=Date.now(),{detSession:r,recSession:i,dict:a}=ii;try{let{imageData:n}=e,{tensor:s,inputH:u,inputW:l,scaleH:p,scaleW:h}=Wf(n),c=new Ne("float32",s,[1,3,u,l]),g={},_=r.inputNames[0]??"x";g[_]=c;let y=await r.run(g),w=r.outputNames[0],S=y[w].data,x=u,b=l,k=S.length-x*b,T=S.slice(k),E=Gf(T,x,b,p,h);if(E.length===0){let P=Date.now()-t;self.postMessage({type:"RESULT",boxes:[],text:"",lines:[],stats:{lineCount:0,charCount:0,durationMs:P,modelScale:e.modelScale??"tiny"}});return}let z=i.inputNames[0]??"x",A=[],v=[],N=[...E].sort((P,V)=>{let Y=Math.min(...P.points.map(U=>U[1])),C=Math.min(...V.points.map(U=>U[1]));return Y-C});for(let P of N){let{tensor:V,width:Y}=Vf(n,P.points),C=new Ne("float32",V,[1,3,48,Y]),U={};U[z]=C;let J=await i.run(U),te=i.outputNames[0],j=J[te],ne=j.data,D=j.dims,ee,K;D.length===3?D[0]===1?(ee=D[1],K=D[2]):(ee=D[0],K=D[2]):(ee=D[0],K=D[1]);let{text:F,confidence:be}=Hf(ne,ee,K,a);F.trim()&&(A.push({points:P.points,text:F,confidence:be}),v.push(F))}let L=v.join(`
`),H=Date.now()-t;self.postMessage({type:"RESULT",boxes:A,text:L,lines:v,stats:{lineCount:v.length,charCount:L.replace(/\s/g,"").length,durationMs:H,modelScale:e.modelScale??"tiny"}})}catch(n){let s=`[OCR] ${n instanceof Error?n.message:String(n)}`;self.postMessage({type:"ERROR",message:s})}}self.addEventListener("message",async e=>{let t=e.data;switch(t.type){case"INIT":await zy(t);break;case"RECOGNIZE":await Cy(t);break;case"DISPOSE":ii=null;break}});
